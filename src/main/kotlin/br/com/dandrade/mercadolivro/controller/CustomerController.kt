...
class CustomerController(
    ...
    fun create(@RequestBody @Valid customer: CustomerRequest): CustomerResponse {
    ...
    fun updateCustomer(@PathVariable id: Long, @Valid @RequestBody request: PutCustomerRequest) {
